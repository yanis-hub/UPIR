...
# Dimensions (mm)
radius_main = 2.5 # Villié  paper
height_main = 150 # Villié  paper 
radius_secondary = radius_main /5
height_secondary = 80 # Villié  paper
num_rotations = 12  # Number of small cylinders around the z-axis
num_repetitions = 7  # Number of repetitions of small cylinders along Z-axis
...
combined_model = combined_model.faces(">Z").workplane().hole(hole_diameter, depth= height_main)
