...
def main(video_path: str = "/Users/yanis/Desktop/output-mosse.MP4", write_csv: bool = True, visualize: bool = True, downsampling: int = None):
        ...
        if is_frame:
            ...
            if frame_id == 0:
                ...
                for object_id, bbox in enumerate(bbox_list):
                    # Utiliser MOSSE pour le tracking
