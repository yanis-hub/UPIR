...
def main(video_path: str = "/Users/yanis/Desktop/N=0 (1).MP4", write_csv: bool = True, visualize: bool = True, downsampling: int = None):
        ...
        if is_frame:
            ...
            if frame_id == 0:
                ...
                for object_id, bbox in enumerate(bbox_list):
                    # Remplace KCF par CSRT ici
                    tracker_list.append(cv.TrackerCSRT_create())
